...
public class ArbolExpresionGrafico extends JPanel 
{
 ...
 public ArbolExpresionGrafico( ArbodeExpresiones miArbol) 
     ...
     * los rectangulos representativos del arbol de la expresion.
     */
    ...
    /**
     * Calcula el tamano de cada subarbol y lo agrega al objeto subtreeSizes de la clase
     ...
     * referencia para calcular la ubicacion de cada nodo.
     * @param left: int con alineacion y orientacion a la izquierda.
     * @param right: int con alineacion y orientación a la derecha.
